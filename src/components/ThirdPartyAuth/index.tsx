...
const ThirdPartyAuth = () => {
  const onGoogleSignIn = () => {
    Linking.openURL("http:localhost:3000/api/auth/google-auth").catch((err) =>
  ...
  return (
    <View>
      <View style={styles.authOptions}>
        <TouchableOpacity style={styles.authOption} onPress={onGoogleSignIn}>
          <SvgXml
            xml={
      ...
      <View style={styles.decorContainer}>
        <View style={styles.decorDivider}></View>
        <Text style={styles.decorText}>or</Text>
        <View style={styles.decorDivider}></View>
      </View>
    </View>
  );
